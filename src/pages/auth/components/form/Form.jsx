            ...
            <div className="max-w-md mx-auto">
                <div>
                    <h1 className="text-2xl font-semibold">
                        { type === 'Login' ? `${user?.username === undefined || user?.username === null ? 'Login' : `Welcome ${user.username}` }` : 'Register here to continue...' }
                    </h1>
                </div>
                <form onSubmit={handleSubmit} >
                            ...
                            </div>
                    {
                        type === 'Register' && (
                            <div className="relative">
                            <input autoComplete="off" id="username" name="username" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="username address" onChange={handleChange} />
                            ...
                            {
                                type === 'Register' && (
                                <p> Click here for <Link to='/login' > Login </Link> </p>
                            )}
                            {
                                type === 'Login' && (

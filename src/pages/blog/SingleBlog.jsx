...
import { deleteBlog, fetchBlog, fetchBlogs, setStatus } from '../../../store/blogSlice'
            ...
            <div className="bg-gray-100 dark:bg-gray-800 py-8 h-screen">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row -mx-4">
                        ...
                        <div className="md:flex-1 px-4">
                            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">{blog?.title || 'Blog Title'}</h2>
                            ...
                            <div className="flex mb-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-gray-600 dark:text-gray-300">{blog?.userId?.createdAt}</span>
                                </div>
                            </div>
